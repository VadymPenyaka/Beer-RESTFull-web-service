...
public class BeerDTO {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$beerName = this.getName();
        final Object other$beerName = other.getName();
    ...
    public int hashCode() {
        ...
        final Object $beerName = this.getName();
    ...
    public String toString() {
        return "Beer(id=" + this.getId() + ", version=" + this.getVersion() + ", beerName=" + this.getName() + ", beerStyle=" + this.getBeerStyle() + ", upc=" + this.getUpc() + ", quantityOnHand=" + this.getQuantityOnHand() + ", price=" + this.getPrice() + ", createdDate=" + this.getCreatedDate() + ", updateDate=" + this.getUpdateDate() + ")";
    }
